...
git add ${workspace?.collectionsFileName || "collections.json"} .api-captain-workspace.json README.md .gitignore
    ...
    <>
      ...
      <Dialog open={manageOpen} onOpenChange={setManageOpen}>
          ...
          <div className="space-y-4 py-2">
            ...
            {workspace?.storageMode === "folder" && workspace.gitEnabled && (
